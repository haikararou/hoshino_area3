		...
		<article class="l-contents">
			<div class="l-contents__conts">
				...
				<section class="l-spacer -small -both -no_top">
					<p>施設規模が小さいため、団体バスでご来場いただける期間を限定させて頂いております。</p>
					<p>受入可能期間におけるバス乗降場および駐車場のご利用は、事前決済による完全予約制です。<br>
				...
				<section class="l-spacer -small -both">
					...
					<dl class="c-list-dl">
						<dt>受入可能期間</dt>
						<dd>2024/11/5～2025/3/31<br><span>＊2025/4/1以降は、受入を予定しておりません。</span></dd>

						<dt>時間・台数</dt>
						<dd>10:00～12:00　1台<br>
						13:30～15:30　1台<br><span>＊時間内でしたら、到着／出発時間はご自由に設定いただけます。<br>
						...
						<dt>支払方法</dt>
						<dd>
							<p>クレジットカードでの事前決済<br><span>＊webサイトからのご予約時に承ります。<br>＊当日支払いは不可。</span></p>
						</dd>

						<dt>予約受付期間</dt>
						<dd>
							<p>3か月前～前日まで<br><span>＊webサイトからのご予約時に承ります。<br>＊当日支払いは不可。</span></p>
						</dd>
