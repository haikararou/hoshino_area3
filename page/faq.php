...
<section class="l-spacer -medium -both">
	<div class="l-container--primary">
		<h1 class="c-title-ex-large">よくある質問</h1>
	</div>
</section>
	...
	<div class="l-container--primary">
		<article class="l-contents--left-title -title-large">
			<div class="l-contents--left-title__title">
				<div>
					<h2 class="c-title-small">施設から探す</h2>
					<ul class="c-list-std">
						<li class="c-list-std__item"><a href="#">すべて</a></li>
						<li class="c-list-std__item"><a href="#">ハルニレテラス</a></li>
						<li class="c-list-std__item"><a href="#">村民食堂</a></li>
						<li class="c-list-std__item"><a href="#">トンボの湯</a></li>
					</ul>
				</div>
			...
			<div class="l-contents--left-title__conts">
				<div class="l-spacer">
					<h3 class="c-title-medium">見出し</h3>
					<dl class="p-faq-list">
