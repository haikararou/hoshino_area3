  ...
  <div class="l-container--primary">
    <article class="l-contents-2column">
      <div class="l-contents-2column__block -w-1_2">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/hotel/hoshinoya.jpg">
      </div>
      <div class="l-contents-2column__block -w-1_2--left">
        ...
        <div class="l-spacer -em2 lang-cn">
          <a href="https://hoshinoresorts.com/zh_cn/brands/hoshinoya/" target="_blank" class="c-button-block -yellow -arrow -more"><span>施設サイト</span></a>
        </div>
        <div class="l-spacer -em2 lang-ko">
          <a href="https://hoshinoresorts.com/ko/brands/hoshinoya/" target="_blank" class="c-button-block -yellow -arrow -more"><span>施設サイト</span></a>
        </div>
...
<section class="l-spacer -mgB-l" id="hbc">
  <div class="l-container--primary">
    <article class="l-contents-2column">
      <div class="l-contents-2column__block -w-1_2">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/hotel/hbc.jpg">
      </div>
      <div class="l-contents-2column__block -w-1_2--left">
        <div class="p-activity--title">
...
<section class="l-spacer -mgB-l" id="beb5">
  <div class="l-container--primary">
    <article class="l-contents-2column">
      <div class="l-contents-2column__block -w-1_2">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/hotel/beb5.jpg">
      </div>
      <div class="l-contents-2column__block -w-1_2--left">
        <div class="p-activity--title">
